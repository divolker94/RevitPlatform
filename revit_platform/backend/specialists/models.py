...
class SpecialistProfile(models.Model):
	...
	specialist_type = models.CharField(max_length=20, choices=SPECIALIST_TYPE_CHOICES, default='executor')
	...
	def __str__(self):
		return f"{self.user.email}'s specialist profile - {self.get_specialist_type_display()}"
